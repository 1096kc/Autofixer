...
public class ImmutableFieldRule extends AbstractLombokAwareRule {
    ...
    public Object visit(ASTClassOrInterfaceDeclaration node, Object data) {
        ...
        for (Map.Entry<VariableNameDeclaration, List<NameOccurrence>> entry : vars.entrySet()) {
            ...
            if (accessNodeParent.isStatic() || !accessNodeParent.isPrivate() || accessNodeParent.isFinal() || accessNodeParent.isVolatile() || hasLombokAnnotation(node) || hasIgnoredAnnotation((Annotatable) accessNodeParent)) {
                continue;
            }
