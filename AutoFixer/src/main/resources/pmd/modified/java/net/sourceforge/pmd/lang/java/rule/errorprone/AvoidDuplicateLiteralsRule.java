...
public class AvoidDuplicateLiteralsRule extends AbstractJavaRule {
    ...
    public static final PropertyDescriptor<Integer> THRESHOLD_DESCRIPTOR = PropertyFactory.intProperty("maxDuplicateLiterals").desc("Max duplicate literals").require(positive()).defaultValue(4).build();
    ...
    public static final PropertyDescriptor<Boolean> SKIP_ANNOTATIONS_DESCRIPTOR = booleanProperty("skipAnnotations").desc("Skip literals within annotations").defaultValue(false).build();
    ...
    public static final StringProperty EXCEPTION_LIST_DESCRIPTOR = StringProperty.named("exceptionList").desc("List of literals to ignore. " + "A literal is ignored if its image can be found in this list. " + "Components of this list should not be surrounded by double quotes.").defaultValue(null).build();
    ...
    public Object visit(ASTCompilationUnit node, Object data) {
        ...
        if (getProperty(EXCEPTION_LIST_DESCRIPTOR) != null) {
            ...
            if (getProperty(EXCEPTION_FILE_DESCRIPTOR) != null) {
