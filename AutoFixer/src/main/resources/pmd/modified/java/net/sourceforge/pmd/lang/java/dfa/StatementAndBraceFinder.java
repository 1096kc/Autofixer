...
public class StatementAndBraceFinder extends JavaParserVisitorAdapter {
    ...
    public Object visit(ASTStatement node, Object data) {
        ...
        if (node.jjtGetParent() instanceof ASTForStatement) {
            ...
            if (node.jjtGetParent() instanceof ASTDoStatement) {
        ...
        if (node.jjtGetParent() instanceof ASTIfStatement) {
            ...
            if (!st.hasElse()) {
                ...
                if (st.hasElse() && !st.jjtGetChild(1).equals(node)) {
            ...
            if (node.jjtGetParent() instanceof ASTWhileStatement) {
                ...
                if (node.jjtGetParent() instanceof ASTForStatement) {
                    ...
                    if (node.jjtGetParent() instanceof ASTLabeledStatement) {
        ...
        for (int i = 0; i < parent.jjtGetNumChildren(); i++) {
            if (parent.jjtGetChild(i) instanceof ASTExpression) {
                ...
                if (parent.jjtGetChild(i) instanceof ASTForUpdate) {
                    ...
                    if (parent.jjtGetChild(i) instanceof ASTForInit) {
                        hasForInitNode = true;
                    }
                }
            }
