...
public class UseStringBufferLengthRule extends AbstractJavaRule {
    ...
    public Object visit(ASTName decl, Object data) {
        ...
        if (alreadySeen.contains(nd) || !(nd instanceof TypedNameDeclaration) || nd instanceof TypedNameDeclaration && TypeHelper.isExactlyNone((TypedNameDeclaration) nd, StringBuffer.class, StringBuilder.class)) {
            return data;
        }
        alreadySeen.add(nd);
        if (isViolation(decl)) {
