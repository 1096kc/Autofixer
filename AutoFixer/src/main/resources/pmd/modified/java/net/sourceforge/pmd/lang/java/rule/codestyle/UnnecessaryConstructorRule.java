...
public class UnnecessaryConstructorRule extends AbstractIgnoredAnnotationRule {
    ...
    public Object visit(ASTClassOrInterfaceDeclaration node, Object data) {
        ...
        if (isExplicitDefaultConstructor(node) && haveSameAccessModifier(node, cons)) {
    ...
    private boolean isExplicitDefaultConstructor(Node node) {
        ...
        return cdnode.getArity() == 0 && !hasIgnoredAnnotation(cdnode) && !cdnode.hasDescendantOfType(ASTBlockStatement.class) && !cdnode.hasDescendantOfType(ASTNameList.class) && hasDefaultConstructorInvocation(cdnode);
    }
