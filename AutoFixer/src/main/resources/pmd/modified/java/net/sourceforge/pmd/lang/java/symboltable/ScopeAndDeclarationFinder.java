...
public class ScopeAndDeclarationFinder extends JavaParserVisitorAdapter {
    ...
    public Object visit(ASTBlock node, Object data) {
        ...
        if (node.jjtGetParent() instanceof ASTMethodDeclaration || node.jjtGetParent() instanceof ASTConstructorDeclaration || node.jjtGetParent() instanceof ASTLambdaExpression || node.jjtGetParent() instanceof ASTCatchStatement || node.jjtGetParent() instanceof ASTForStatement) {
