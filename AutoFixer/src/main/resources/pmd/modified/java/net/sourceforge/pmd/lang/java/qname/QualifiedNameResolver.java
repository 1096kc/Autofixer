...
public class QualifiedNameResolver extends JavaParserVisitorReducedAdapter {
    ...
    private ImmutableList<String> getLongestPackagePrefix(String acc, int i) {
        ...
        if (i == 1) {
            // no prefix known, return early because there's no more '.' in acc
            return ListFactory.emptyList();
        }
    ...
    public Object visit(ASTLambdaExpression node, Object data) {
        String opname = "lambda$" + findLambdaScopeNameSegment(node) + "$" + lambdaCounters.peek().getAndIncrement();
                    ...
                    if (parent instanceof ASTEnumConstant) {
                        ...
                        if (parent instanceof ASTFieldDeclaration) {
                            ...
                            if (innermostEnclosingTypeName.peek().isAnonymousClass()) {
                                ...
                                if (innermostEnclosingTypeName.peek().isLocalClass()) {
