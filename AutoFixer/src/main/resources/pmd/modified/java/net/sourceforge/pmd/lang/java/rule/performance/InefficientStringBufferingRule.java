...
public class InefficientStringBufferingRule extends AbstractJavaRule {
    ...
    public Object visit(ASTAdditiveExpression node, Object data) {
        ...
        if (bs.isAllocation()) {
            ...
            if (isInStringBufferOperation(node, 6, "append")) {
                addViolation(data, node);
            }
        }
        return data;
    ...
    protected static boolean isInStringBufferOperation(Node node, int length, String methodName) {
        ...
        return TypeHelper.isExactlyAny((TypedNameDeclaration) n.getNameDeclaration(), StringBuffer.class, StringBuilder.class);
    }
