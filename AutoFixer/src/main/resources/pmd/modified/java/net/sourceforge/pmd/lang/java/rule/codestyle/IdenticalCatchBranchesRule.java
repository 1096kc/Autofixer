...
public class IdenticalCatchBranchesRule extends AbstractJavaRule {
    ...
    private boolean basicEquivalence(Node node1, Node node2, String varName1, String varName2) {
        ...
        return Objects.equals(image1, image2) || // or must be references to the variable we allow to interchange
        Objects.equals(image1, varName1) && Objects.equals(image2, varName2) && // which means we must filter out method references.
