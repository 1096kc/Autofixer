            ...
            for (int a = 0; a < argumentList.jjtGetNumChildren(); a++) {
                ...
                if (arg != null && arg.jjtGetNumChildren() > 0) {
                    if (arg.jjtGetChild(0) instanceof ASTLiteral) {
                            ...
                            if (lit.isFloatLiteral()) {
                                ...
                                if (lit.isIntLiteral()) {
                                    ...
                                    if (lit.isStringLiteral()) {
                                        ...
                                        if (lit.jjtGetNumChildren() > 0 && lit.jjtGetChild(0) instanceof ASTBooleanLiteral) {
                                            type = "boolean";
                                        } else {
                                            if (lit.isDoubleLiteral()) {
                                                type = "double";
                                            } else {
                                                if (lit.isLongLiteral()) {
                                                    type = "long";
                                                }
                                            }
                                        }
                        ...
                        if (arg.jjtGetChild(0) instanceof ASTName) {
