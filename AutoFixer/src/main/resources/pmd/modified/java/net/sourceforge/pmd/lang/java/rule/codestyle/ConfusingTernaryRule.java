    ...
    public Object visit(ASTIfStatement node, Object data) {
        ...
        if (node.jjtGetNumChildren() == 3) {
            ...
            if (inode instanceof ASTExpression && inode.jjtGetNumChildren() == 1) {
                ...
                if (isMatch(jnode)) {
                    if (!getProperty(ignoreElseIfProperty) || !(node.jjtGetChild(2).jjtGetChild(0) instanceof ASTIfStatement) && !(node.jjtGetParent().jjtGetParent() instanceof ASTIfStatement)) {
