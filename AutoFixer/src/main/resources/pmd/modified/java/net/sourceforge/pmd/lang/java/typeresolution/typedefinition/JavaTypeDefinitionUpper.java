...
/* default */
class JavaTypeDefinitionUpper extends JavaTypeDefinition {
    ...
    public String toString() {
        StringBuilder builder = new StringBuilder().append("JavaTypeDefinition ").append(getDefinitionType()).append(" [").append(typeList[0]);
        for (int index = 1; index < typeList.length; ++index) {
            builder.append(" && ").append(typeList[index]);
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (otherTypeDef.getJavaTypeCount() != getJavaTypeCount() || getDefinitionType() != otherTypeDef.getDefinitionType()) {
            return false;
        }
