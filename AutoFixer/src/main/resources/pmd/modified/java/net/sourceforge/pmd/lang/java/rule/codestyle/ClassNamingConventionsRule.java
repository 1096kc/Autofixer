...
public class ClassNamingConventionsRule extends AbstractNamingConventionRule<ASTAnyTypeDeclaration> {
    ...
    private boolean isMainMethod(ASTAnyTypeBodyDeclaration bodyDeclaration) {
        ...
        return decl.isStatic() && "main".equals(decl.getName()) && decl.getResultType().isVoid() && decl.getFormalParameters().getParameterCount() == 1 && String[].class.equals(decl.getFormalParameters().iterator().next().getType());
    }
