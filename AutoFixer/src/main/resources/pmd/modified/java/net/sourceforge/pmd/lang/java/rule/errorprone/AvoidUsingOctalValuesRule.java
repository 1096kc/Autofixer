...
public class AvoidUsingOctalValuesRule extends AbstractJavaRule {
    ...
    private static final PropertyDescriptor<Boolean> STRICT_METHODS_DESCRIPTOR = booleanProperty("strict").desc("Detect violations between 00 and 07").defaultValue(false).build();
