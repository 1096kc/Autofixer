...
public class SimpleTypedNameDeclaration implements TypedNameDeclaration {
    ...
    private boolean internalEquals(Object obj) {
        ...
        if (typeImage == null) {
            ...
            if (!typeImage.equals(other.typeImage)) {
                ...
                if (other.typeImage != null) {
                    ...
                    if (primitiveTypes.contains(lcType) && primitiveTypes.contains(otherLcType)) {
                        if (lcType.equals(otherLcType)) {
                            ...
                            if (("char".equals(lcType) || "character".equals(lcType)) && ("char".equals(otherLcType) || "character".equals(otherLcType))) {
                                return true;
                            } else {
                                if (("int".equals(lcType) || "integer".equals(lcType)) && ("int".equals(otherLcType) || "integer".equals(otherLcType) || "short".equals(otherLcType) || "char".equals(otherLcType) || "character".equals(otherLcType) || "byte".equals(otherLcType))) {
                                    return true;
                                } else {
                                    if ("double".equals(lcType) && ("float".equals(otherLcType) || "int".equals(otherLcType) || "integer".equals(otherLcType) || "long".equals(otherLcType))) {
                                        return true;
                                    } else {
                                        if ("float".equals(lcType) && ("int".equals(otherLcType) || "integer".equals(otherLcType) || "long".equals(otherLcType))) {
                                            return true;
                                        } else {
                                            if ("long".equals(lcType) && ("int".equals(otherLcType) || "integer".equals(otherLcType) || "char".equals(otherLcType) || "character".equals(otherLcType))) {
                                                return true;
                                            }
                                        }
                                    }
