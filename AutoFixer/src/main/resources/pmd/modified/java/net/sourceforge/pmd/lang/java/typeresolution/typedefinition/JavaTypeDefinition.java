...
public abstract class JavaTypeDefinition implements TypeDefinition {
    ...
    public static JavaTypeDefinition forClass(final Class<?> clazz, JavaTypeDefinition... boundGenerics) {
        ...
        try {
            ...
            // Can happen if a parent class references a class not in classpath
            return null;
        }
    ...
    public final boolean isUpperBound() {
        return definitionType == TypeDefinitionType.UPPER_BOUND || definitionType == TypeDefinitionType.UPPER_WILDCARD;
    }
    ...
    public final boolean isWildcard() {
        return definitionType == TypeDefinitionType.LOWER_WILDCARD || definitionType == TypeDefinitionType.UPPER_WILDCARD;
    }
