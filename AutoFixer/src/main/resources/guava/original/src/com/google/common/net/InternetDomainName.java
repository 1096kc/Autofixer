...
public final class InternetDomainName {
   ...
   * {@link #isRegistrySuffix()} if the domain ends with an excluded domain patterns such as {@code
   * "nhs.uk"}.
   *
   ...
   * desiredType} is specified, the wildcard patterns must also match that type.
   */
