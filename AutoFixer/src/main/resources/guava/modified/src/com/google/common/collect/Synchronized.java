...
final class Synchronized {
    ...
    private static final class SynchronizedTable<R, C, V> extends SynchronizedObject implements Table<R, C, V> {
        ...
        public Map<R, Map<C, V>> rowMap() {
            synchronized (mutex) {
                return map(Maps.transformValues(delegate().rowMap(), new com.google.common.base.Function<Map<C, V>, Map<C, V>>() {
        ...
        public Map<C, Map<R, V>> columnMap() {
            synchronized (mutex) {
                return map(Maps.transformValues(delegate().columnMap(), new com.google.common.base.Function<Map<R, V>, Map<R, V>>() {
