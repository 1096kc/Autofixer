   ...
   */
    ...
    class WrappedList extends WrappedCollection implements List<V> {
        ...
        public List<V> subList(int fromIndex, int toIndex) {
            refreshIfEmpty();
            return wrapList(getKey(), getListDelegate().subList(fromIndex, toIndex), getAncestor() == null ? this : getAncestor());
        }
    ...
    Spliterator<V> valueSpliterator() {
        return CollectSpliterators.flatMap(map.values().spliterator(), Collection::spliterator, Spliterator.SIZED, size());
    }
