...
public final class Multimaps {
    ...
    @Beta
    @SuppressWarnings("unchecked")
    public static <// safe by specification of ListMultimap.asMap()
    K, V> Map<K, List<V>> asMap(ListMultimap<K, V> multimap) {
    ...
    @Beta
    @SuppressWarnings("unchecked")
    public static <// safe by specification of SetMultimap.asMap()
    K, V> Map<K, Set<V>> asMap(SetMultimap<K, V> multimap) {
    ...
    @Beta
    @SuppressWarnings("unchecked")
    public static <// safe by specification of SortedSetMultimap.asMap()
    K, V> Map<K, SortedSet<V>> asMap(SortedSetMultimap<K, V> multimap) {
