...
public final class TreeRangeMap<K extends Comparable, V> implements RangeMap<K, V> {
     ...
     */
    private static <K extends Comparable, V> Range<K> coalesce(Range<K> range, V value, @Nullable Entry<Cut<K>, RangeMapEntry<K, V>> entry) {
     ...
     */
        Entry<Cut<K>, RangeMapEntry<K, V>> mapEntryBelowToTruncate = entriesByLowerBound.lowerEntry(rangeToRemove.lowerBound);
        ...
        Entry<Cut<K>, RangeMapEntry<K, V>> mapEntryAboveToTruncate = entriesByLowerBound.lowerEntry(rangeToRemove.upperBound);
    ...
    public void merge(Range<K> range, @Nullable V value, BiFunction<? super V, ? super V, ? extends V> remappingFunction) {
        ...
        Set<Entry<Cut<K>, RangeMapEntry<K, V>>> entriesInMergeRange = entriesByLowerBound.subMap(range.lowerBound, range.upperBound).entrySet();
    ...
    private static final RangeMap EMPTY_SUB_RANGE_MAP = new RangeMap() {
        ...
        @Override
        // necessary for static EMPTY_SUB_RANGE_MAP instance
    ...
    private class SubRangeMap implements RangeMap<K, V> {
        ...
        public Range<K> span() {
            ...
            if (upperEntry == null) {
                ...
                if (upperEntry.getValue().getUpperBound().compareTo(subRange.upperBound) >= 0) {
