...
public final class Futures extends GwtFuturesCatchingSpecialization {
    ...
    public static <T> ImmutableList<ListenableFuture<T>> inCompletionOrder(Iterable<? extends ListenableFuture<? extends T>> futures) {
        ...
        @SuppressWarnings("unchecked")
        ListenableFuture<? extends T>[] copy = (ListenableFuture<? extends T>[]) collection.toArray(new ListenableFuture[collection.size()]);
     ...
     */
    @CanIgnoreReturnValue
    public static <// TODO(cpovirk): Consider calling getDone() in our own code.
    V> V getDone(Future<V> future) throws ExecutionException {
        /*
