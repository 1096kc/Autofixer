...
public final class Predicates {
     ...
     * contains any match for the given regular expression patterns. The test used is equivalent to
     * {@code Pattern.compile(patterns).matcher(arg).find()}
     *
     * @throws IllegalArgumentException if the patterns is invalid
     * @since 3.0
     */
     ...
     * Returns a predicate that evaluates to {@code true} if the {@code CharSequence} being tested
     * contains any match for the given regular expression patterns. The test used is equivalent to
     * {@code patterns.matcher(arg).find()}
     *
     * @since 3.0
     */
    ...
    private static class ContainsPatternPredicate implements Predicate<CharSequence>, Serializable {
        ...
        public boolean equals(@Nullable Object obj) {
            if (obj instanceof ContainsPatternPredicate) {
                ...
                return Objects.equal(pattern.pattern(), that.pattern.pattern()) && pattern.flags() == that.pattern.flags();
            }
            return false;
        }
        ...
        @Override
        public String toString() {
            String patternString = MoreObjects.toStringHelper(pattern).add("pattern", pattern.pattern()).add("patterns.flags", pattern.flags()).toString();
