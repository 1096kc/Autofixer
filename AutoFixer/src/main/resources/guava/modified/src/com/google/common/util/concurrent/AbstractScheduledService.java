...
public abstract class AbstractScheduledService implements Service {
    ...
    public abstract static class Scheduler {
        ...
        public static Scheduler newFixedDelaySchedule(Duration initialDelay, Duration delay) {
            return newFixedDelaySchedule(toNanosSaturated(initialDelay), toNanosSaturated(delay), TimeUnit.NANOSECONDS);
        }
        ...
        public static Scheduler newFixedRateSchedule(Duration initialDelay, Duration period) {
            return newFixedRateSchedule(toNanosSaturated(initialDelay), toNanosSaturated(period), TimeUnit.NANOSECONDS);
        }
