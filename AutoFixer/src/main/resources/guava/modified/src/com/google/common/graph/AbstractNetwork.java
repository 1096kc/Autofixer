...
public abstract class AbstractNetwork<N, E> implements Network<N, E> {
    ...
    public Set<E> adjacentEdges(E edge) {
        // Verifies that edge is in this network.
    ...
    public Set<E> edgesConnecting(N nodeU, N nodeV) {
        ...
        return outEdgesU.size() <= inEdgesV.size() ? unmodifiableSet(Sets.filter(outEdgesU, connectedPredicate(nodeU, nodeV))) : unmodifiableSet(Sets.filter(inEdgesV, connectedPredicate(nodeV, nodeU)));
    }
