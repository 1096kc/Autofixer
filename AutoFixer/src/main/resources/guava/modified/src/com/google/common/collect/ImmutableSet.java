...
public abstract class ImmutableSet<E> extends ImmutableCollection<E> implements Set<E> {
     ...
     */
    // For Eclipse. For internal javac we have disabled this pointless type of warning.
    @SafeVarargs
    ...
    private static <E> ImmutableSet<E> constructUnknownDuplication(int n, Object... elements) {
        ...
        return construct(n, Math.max(ImmutableCollection.Builder.DEFAULT_INITIAL_CAPACITY, IntMath.sqrt(n, RoundingMode.CEILING)), elements);
    }
   ...
   */
    ...
    static boolean hashFloodingDetected(Object[] hashTable) {
        ...
        blockLoop: for (int i = endOfStartRun + 1; i + testBlockSize <= startOfEndRun; i += testBlockSize) {
    ...
    private static final class RegularSetBuilderImpl<E> extends SetBuilderImpl<E> {
        ...
        SetBuilderImpl<E> add(E e) {
            ...
            for (int i = i0; i - i0 < maxRunBeforeFallback; i++) {
                ...
                if (tableEntry == null) {
                    ...
                    hashTable[index] = e;
                    hashCode += eHash;
                    // rebuilds table if necessary
                    ensureTableCapacity(distinct);
                    return this;
                } else {
                    if (tableEntry.equals(e)) {
                        // not a new element, ignore
                        return this;
                    }
                }
            }
        ...
        ImmutableSet<E> build() {
            switch(distinct) {
                ...
                default:
                    Object[] elements = distinct == dedupedElements.length ? dedupedElements : Arrays.copyOf(dedupedElements, distinct);
