...
public final class Throwables {
    ...
    @GwtIncompatible
    public static // TODO(cpovirk): Consider making this available under GWT (slow implementation only).
    List<StackTraceElement> lazyStackTrace(Throwable throwable) {
     ...
     *
     * TODO(cpovirk): Consider the UnsignedBytes patterns if it performs faster and doesn't cause
     * AOSP grief.
     */
