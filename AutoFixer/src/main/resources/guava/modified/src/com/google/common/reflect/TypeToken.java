...
public abstract class TypeToken<T> extends TypeCapture<T> implements Serializable {
    ...
    private TypeToken<? super T> getArraySupertype(Class<? super T> supertype) {
        ...
        @SuppressWarnings("unchecked")
        TypeToken<? super T> result = (TypeToken<? super T>) // If we are passed with int[].class, don't turn it to GenericArrayType
    ...
    private TypeToken<? extends T> getArraySubtype(Class<?> subclass) {
        ...
        @SuppressWarnings("unchecked")
        TypeToken<? extends T> result = (TypeToken<? extends T>) // If we are passed with int[].class, don't turn it to GenericArrayType
