        ...
        while (true) {
            ...
            if (byte1 < (byte) 0xE0) {
                ...
                if (byte1 < (byte) 0xF0) {
                    ...
                    if (byte2 > (byte) 0xBF || byte1 == (byte) 0xE0 && byte2 < (byte) 0xA0 || byte1 == (byte) 0xED && (byte) 0xA0 <= byte2 || // Third byte trailing-byte test.
                    ...
                    int byte2 = bytes[index++];
                    if (byte2 > (byte) 0xBF || // Check that 1 <= plane <= 16. Tricky optimized form of:
                    // if (byte1 > (byte) 0xF4
                    // || byte1 == (byte) 0xF0 && byte2 < (byte) 0x90
                    // || byte1 == (byte) 0xF4 && byte2 > (byte) 0x8F)
                    ((byte1 << 28) + (byte2 - (byte) 0x90)) >> 30 != 0 || // Third byte trailing-byte test
                    bytes[index++] > (byte) 0xBF || // Fourth byte trailing-byte test
                    bytes[index++] > (byte) 0xBF) {
                        return false;
                    }
                }
