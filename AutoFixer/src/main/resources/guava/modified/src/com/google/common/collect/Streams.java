...
public final class Streams {
    ...
    public static <T> Stream<T> concat(Stream<? extends T>... streams) {
        ...
        return StreamSupport.stream(CollectSpliterators.flatMap(splitrsBuilder.build().spliterator(), splitr -> (Spliterator<T>) splitr, characteristics, estimatedSize), isParallel).onClose(() -> closeAll(streams));
    }
    ...
    public static LongStream concat(LongStream... streams) {
        ...
        return StreamSupport.longStream(CollectSpliterators.flatMapToLong(splitrsBuilder.build().spliterator(), splitr -> splitr, characteristics, estimatedSize), isParallel).onClose(() -> closeAll(streams));
    }
